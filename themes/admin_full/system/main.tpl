...
<div id="outer">
    ...
    <div id="footer" class="clearfix">
      ...
      <div style="float:right;text-align:center;padding-top:10px;padding-right:10px;">
           <b>Design & Developed by:</b>
            <hr/>
<a href="http://levietpro.com" style="color:red;font-weight:bold;">LeViet.pro</a> (Hotline: 091.991.6686)
        </div>
    </div>
