...
<link rel="stylesheet" type="text/css" href="{NV_BASE_SITEURL}themes/default/css/slideshow.css" media="screen" />
...
<div id="slider" style="width: {DATA.file_width}px; height: {DATA.file_height}px;">
        <ul id="sliderContent" style="width: {DATA.file_width}px">
        			<!-- BEGIN: loop -->
