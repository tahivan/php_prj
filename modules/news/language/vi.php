...
$lang_module['comment_login'] =
    'Bạn cần đăng nhập thành viên để sử dụng chức năng này';
$lang_module['comment_success'] = 'Bình luận thành công';
$lang_module['comment_unsuccess'] =
    'Lỗi trình quá trình xử lý dữ liệu hoặc dữ liệu không đầy đủ';
...
$lang_module['comment_timeout'] =
    'Bạn đã bình chọn vui lòng đợi %s phút sau để có gửi bình luận.';
...
$lang_module['sendmail_welcome'] =
    'Xin chào! Bạn đã nhận được một email từ hệ thống';
$lang_module['sendmail_welcome1'] = 'Sau đây là nội dung: ';
$lang_module['sendmail_welcome2'] =
    'Bạn có thể xem đầy đủ bài viết tại link bên dưới:';
$lang_module['sendmail_success'] = 'Bạn đã gửi email thành công tới';
$lang_module['sendmail_success_err'] =
    'Vì một lý do nào đó mà hệ thống đã không thể thực hiện được yêu cầu của bạn. Thành thật xin lỗi vì sự bất tiện này!';
...
$lang_module['stringrating'] =
    'Tổng số điểm của bài viết là: %1$s trong %2$s đánh giá';
...
$lang_module['save_content_ok'] =
    'Đăng bài viết thành công. <br />Trình duyệt sẽ tự động chuyển về trang quản lý bài viết.';
$lang_module['save_content_view_page'] =
    'Đăng bài viết thành công. <br />Trình duyệt sẽ tự động chuyển về bài viết bạn vừa đăng.';
$lang_module['save_content_waite'] =
    'Bài viết bạn gửi đã được hệ thống ghi nhận, <br />ban quản trị site sẽ kiểm tra bài viết và đăng bài viết trong thời gian sớm nhất, <br />trình duyệt sẽ tự động chuyển về trang quản lý bài viết.';
$lang_module['save_content_waite_home'] =
    'Bài viết bạn gửi đã được hệ thống ghi nhận, <br />ban quản trị site sẽ kiểm tra bài viết và đăng bài viết trong thời gian sớm nhất, <br />trình duyệt sẽ tự động chuyển về trang chủ.';
$lang_module['error_addcontent'] =
    'Lỗi: Bạn chưa được cấp quyền để gửi bài viết';
$lang_module['errorsave'] =
    'Lỗi hệ thống không cập nhật được nội dung, bạn hãy kiểm tra lại tiêu đề bài viết có thể bị trùng';
