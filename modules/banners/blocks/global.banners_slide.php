...
if( ! nv_function_exists( 'nv_block_data_config_banners_slide' ) )
{
	function nv_block_data_config_banners_slide( $module, $data_block, $lang_block )
	{
	...
	function nv_block_data_config_banners_slide_submit( $module, $lang_block )
	{
		global $nv_Request;
		$return = array();
		$return['error'] = array();
	...
	function nv_block_global_banners_slide( $block_config )
	{
		...
		if( file_exists( NV_ROOTDIR . "/themes/" . $global_config['module_theme'] . "/blocks/global.banners_slide.tpl" ) )
		{
			$block_theme = $global_config['module_theme'];
		}
		elseif( file_exists( NV_ROOTDIR . "/themes/" . $global_config['site_theme'] . "/blocks/global.banners_slide.tpl" ) )
		{
		...
		$xtpl = new XTemplate( "global.banners_slide.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/blocks" );
...
{
	$content = nv_block_global_banners_slide( $block_config );
}
