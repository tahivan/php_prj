...
if( ! nv_function_exists( 'nv_block_data_config_banners_slide' ) )
{
	...
	function nv_block_global_banners_slide( $block_config )
	{
		...
		if( file_exists( NV_ROOTDIR . "/themes/" . $global_config['module_theme'] . "/blocks/global.banners_home.tpl" ) )
		{
			$block_theme = $global_config['module_theme'];
		}
		elseif( file_exists( NV_ROOTDIR . "/themes/" . $global_config['site_theme'] . "/blocks/global.banners_home.tpl" ) )
		{
		...
		$xtpl = new XTemplate( "global.banners_home.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/blocks" );
