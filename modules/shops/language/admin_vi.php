...
$lang_module['categories'] = 'Tour theo vùng';
$lang_module['topics'] = 'Tiêu chí cho tour theo vùng';
$lang_module['sources'] = 'Điểm đến';
$lang_module['comments'] = 'Bình luận';
$lang_module['save'] = 'Lưu thay đổi';
$lang_module['action'] = 'Thực hiện';
$lang_module['move'] = 'Di chuyển tour';
$lang_module['save_temp'] = 'Lưu tour không đăng';
$lang_module['publtime'] = 'Đăng tour';
$lang_module['exptime'] = 'Cho hết hạn tour';
...
$lang_module['saveok'] = 'Cập nhật tour thành công';
$lang_module['alias'] = 'Liên kết tĩnh';
$lang_module['name'] = 'Tên tour';
$lang_module['error_name'] = 'Lỗi:Bạn cần nhập tên tour';
$lang_module['weight'] = 'vị trí';
$lang_module['numsubcat'] = 'Số tour con';
...
$lang_module['content_list'] = 'Danh sách tour';
$lang_module['content_add'] = 'Thêm tour';
$lang_module['add_cat'] = 'Thêm Tour theo vùng';
$lang_module['add_topic'] = 'Thêm nhóm tour';
$lang_module['add_sources'] = 'Thêm điểm đến';
$lang_module['edit_cat'] = 'Sửa Tour theo vùng';
$lang_module['edit_topic'] = 'Sửa nhóm tour';
$lang_module['edit_sources'] = 'Sửa điểm đến';
$lang_module['siteinfo_publtime'] = 'Tổng số tour';
$lang_module['siteinfo_pending'] = 'Số tour chờ đăng';
...
$lang_module['siteinfo_expired'] = 'Số tour đã hết hạn';
$lang_module['catalog_name'] = 'Tên Tour theo vùng';
$lang_module['topics_name'] = 'Tên nhóm tour';
$lang_module['add_block_cat'] = 'Thêm nhóm block';
$lang_module['edit_block_cat'] = 'Sửa nhóm block';
$lang_module['content_add_items'] = 'Danh sách tour';
$lang_module['content_main'] = 'Thông tin module';
$lang_module['document_payment'] = 'Hướng dẫn thanh toán';
$lang_module['document_payment_note'] = 'Nội dung này hiển trong phần chi tiết mỗi tour hỗ trợ thanh toán';
$lang_module['cat_title'] = 'Danh sách Tour theo vùng';
$lang_module['link'] = 'url điểm đến';
$lang_module['cat_sub'] = 'Thuộc chủ đề';
$lang_module['cat_sub_sl'] = 'Là chủ đề chính';
$lang_module['topic_sl'] = 'Chọn nhóm tour hoặc tự điền';
$lang_module['delcat_msg_cat'] = 'Chủ đề này có %s chủ đề thành phần, bạn cần xóa hoặc di chuyển các chủ đề thành phần trước';
$lang_module['delcat_msg_rows'] = 'Chủ đề có %s tour, bạn có chắc chắn xóa hoặc di chuyển sang chủ đề khác';
$lang_module['delcat_msg_rows_select'] = 'Chú ý: chủ đề %1$s có %2$s tour. <br>Bạn xóa chủ đề này tức là xóa tất cả tour bên trong nó.';
$lang_module['delcat_msg_rows_move'] = 'Hoặc chọn chủ đề để di chuyển tour tới';
$lang_module['delcatandrows'] = 'Xóa chủ đề và các tour';
$lang_module['delcat_msg_rows_noselect'] = 'Bạn cần chọn chủ đề để di chuyển tour tới';
$lang_module['deltopic_msg_rows'] = 'nhóm tour này có %s tour, bạn có chắc chắn xóa, khi đó nhóm tour sẽ bị xóa khỏi các tour.';
$lang_module['delsource_msg_rows'] = 'điểm đến có %s tour bạn phải di chuyển chúng sang điểm đến khác hoặc xóa chúng mới có thể xóa điểm đến này';
...
$lang_module['setting_hometext'] = 'Hiển thị phần giới thiệu gắn gọn khi xem chi tiết tour';
$lang_module['setting_per_page'] = 'Số tour được hiển thị trong một trang [A]';
$lang_module['setting_per_row'] = 'Số tour được hiển thị trên một hàng (hiển thị dạng lưới) [B]';
...
$lang_module['setting_up_products'] = 'Tự động đăng tour không cần qua kiểm duyệt (thành viên)';
$lang_module['setting_up_products_shop'] = 'Tự động đăng tour không cần qua kiểm duyệt (gian hàng)';
$lang_module['setting_order_to_admin'] = 'Đặt hàng tour gửi tới Ban quản trị';
$lang_module['setting_order_to_member'] = 'Đặt hàng tour gửi tới người đăng tour';
...
$lang_module['setting_active_price'] = 'Hiển thị giá tour';
$lang_module['setting_active_order_number'] = 'Kích hoạt chức năng đặt hàng không giới hạn số lượng tour';
...
$lang_module['setting_active_tooltip'] = 'Bật chức năng tooltip cho tour';
$lang_module['setting_show_product_code'] = 'Hiển thị mã tour';
...
$lang_module['viewcat_page'] = 'Cách thể hiện Tour theo vùng';
...
$lang_module['view_home_none'] = 'Không hiển thị tour';
$lang_module['view_home_all'] = 'Hiển thị tất cả tour lên trang chủ';
$lang_module['view_home_cat'] = 'Hiển thị theo Tour theo vùng';
$lang_module['view_home_group'] = 'Hiển thị theo nhóm tour';
$lang_module['cat_have_product_err'] = 'Bạn không thể thêm Tour theo vùng vào chủ đề đã có tour bên trong';
...
$lang_module['search_cat'] = 'Tour theo vùng';
$lang_module['search_cat_all'] = 'Tất cả các Tour theo vùng';
$lang_module['search_title'] = 'Tên tour';
$lang_module['search_bodytext'] = 'Nội dung';
$lang_module['search_author'] = 'Tác giả tour';
$lang_module['search_admin'] = 'Người nhập liệu';
$lang_module['search_per_page'] = 'Số tour hiển thị';
...
$lang_module['error_title'] = 'Lỗi: tour chưa có tên';
$lang_module['error_product_code'] = 'Lỗi: Mã tour bạn chọn bị trùng';
$lang_module['error_bodytext'] = 'Lỗi: tour chưa có nội dung';
$lang_module['error_hometext'] = 'Lỗi: Phần giới thiệu ngắn gọn chưa có nội dung';
$lang_module['error_product_unit'] = 'Bạn cần thêm đơn vị cho tour';
$lang_module['error_cat'] = 'Lỗi: tour chưa có Tour theo vùng';
$lang_module['error_product_price'] = 'Lỗi: giá tour không được âm hoặc bằng 0. Nếu bạn không muốn hiển thị giá, hãy hủy tùy chọn Cho phép hiển thị giá tour này ở phần Tính năng mở rộng';
$lang_module['error_product_discounts'] = 'Lỗi: tỷ lệ giảm giá không được âm';
$lang_module['sources_sl'] = 'Hãy chọn hoặc tự điền';
$lang_module['content_cat'] = 'Tour theo vùng';
$lang_module['content_block'] = 'tour thuộc các block';
$lang_module['content_topic'] = 'Là thành phần của nhóm tour';
$lang_module['content_homeimg'] = 'Hình minh họa cho phần giới thiệu';
$lang_module['content_homeimgalt'] = 'Chú thích cho hình minh họa (phần chi tiết tour)';
...
$lang_module['content_keywords_note'] = 'Để tạo tự động, hãy copy toàn bộ nội dung tour vào ô trống dưới đây và bấm';
...
$lang_module['content_allowed_send'] = 'Cho phép gửi tour';
$lang_module['content_allowed_print'] = 'Cho phép in tour';
$lang_module['content_allowed_save'] = 'Cho phép lưu tour';
$lang_module['content_allshow'] = 'Xem tất cả ';
$lang_module['content_allcollapse'] = 'Đóng tắt cả';
$lang_module['content_bodytext'] = 'Nội dung dành cho khách đoàn';
...
$lang_module['content_note'] = 'Phương tiện';
$lang_module['content_product_code'] = 'Mã tour';
$lang_module['content_product_number'] = 'Số lượng trong kho';
$lang_module['content_product_number1'] = 'SL trong kho';
$lang_module['content_product_product_price'] = 'Giá tour';
$lang_module['content_product_money_unit'] = 'Đơn vị tiền tệ';
$lang_module['content_product_address'] = 'Nơi đi';
$lang_module['content_sourceid'] = 'điểm đến';
$lang_module['content_product_discounts'] = 'Giảm giá';
$lang_module['content_copyright'] = 'Giữ bản quyền tour';
$lang_module['content_archive'] = 'Lưu trữ sau thời gian hết hạn';
$lang_module['content_showprice'] = 'Cho phép hiển thị giá tour này';
$lang_module['content_promotional'] = 'Thời gian tour';
$lang_module['content_warranty'] = 'Khách sạn';
$lang_module['content_showorder'] = 'Cho phép đặt hàng tour này';
$lang_module['imgposition'] = 'Hình ảnh tại tour';
...
$lang_module['addtoblock'] = 'Thêm tour vào block';
$lang_module['delete_from_block'] = 'Xóa tour khỏi block';
$lang_module['error_del_content'] = 'Lỗi: Hệ thống không xóa hết được các tour, vui lòng thử lại';
$lang_module['msgnocheck'] = 'Bạn cần chọn ít nhất 1 tour để thực hiện';
$lang_module['comment'] = 'Quản lý bình luận';
$lang_module['activecomm'] = 'Kích hoạt chức năng bình luận cho tour';
...
$lang_module['comment_topic'] = 'tour';
...
$lang_module['block'] = 'Block tour';
$lang_module['block_name'] = 'Tên block tour';
$lang_module['block_error_name'] = 'Lỗi: Tên block tour không được để trống';
$lang_module['block_error_alias'] = 'Lỗi: Liên kết tĩnh này đã tồn tại, hãy chọn tên khác';
$lang_module['adddefaultblock'] = 'Chọn mặc định khi đăng tour';
$lang_module['source_logo'] = 'Logo điểm đến';
$lang_module['source_title'] = 'Tên điểm đến';
$lang_module['source_error_title'] = 'Lỗi: Tên điểm đến còn trống';
...
$lang_module['topic_page'] = 'tour thuộc nhóm liên quan';
$lang_module['topic_del'] = 'Xóa khỏi nhóm tour này';
$lang_module['topic_nocheck'] = 'Hãy chọn ít nhất 1 tour để có thể thực hiện';
$lang_module['topic_delete_confirm'] = 'Bạn có chắc muốn xóa tiêu chí này?';
$lang_module['topic_delete_success'] = 'Loại bỏ thành công !';
$lang_module['topic_nonews'] = 'Hiện tại không có tour nào thuộc nhóm tour này !';
$lang_module['addtotopics'] = 'Thêm vào nhóm tour';
$lang_module['topic_update_success'] = 'Cập nhật thành công !';
$lang_module['topic_num_news'] = ' tour';
$lang_module['content_product_shop'] = 'Gian hàng';
$lang_module['prounit'] = 'Đơn vị tour';
$lang_module['prounit_name_unit'] = 'Tên đơn vị tour';
$lang_module['prounit_name_note'] = 'Phương tiện';
...
$lang_module['format_code_id'] = 'Định dạng mã tour tự động';
...
$lang_module['order_products_name'] = 'tour';
$lang_module['order_product_numbers'] = 'SL';
$lang_module['order_products_note'] = 'Phương tiện';
...
$lang_module['product_number_all'] = 'Tổng số tour đã cập nhật';
$lang_module['product_number_all_noctive'] = 'Tổng số tour đã cập nhật nhưng chưa duyệt';
$lang_module['product_number_commet'] = 'Tổng số bình luận cho tour';
$lang_module['product_number_all_store'] = 'Tổng số tour còn lại trong kho';
...
$lang_module['product_unit'] = 'tour';
$lang_module['product_comment'] = 'bình luận';
$lang_module['product_order'] = 'đơn đặt';
$lang_module['detail_info'] = 'Chi tiết';
$lang_module['group'] = 'Nhóm tour';
$lang_module['group_sub_sl'] = 'Nhóm chính';
$lang_module['edit_group'] = 'Sửa nhóm tour';
$lang_module['add_group'] = 'Thêm nhóm tour';
$lang_module['group_name'] = 'Tên nhóm tour';
...
$lang_module['delgroup_msg_rows'] = 'Nhóm này có %s tour, bạn có chắc chắn xóa hoặc di chuyển sang nhóm khác';
$lang_module['delgroup_msg_rows_select'] = 'Chú ý: Nhóm %1$s có %2$s tour. <br>Bạn xóa nhóm này tức là xóa tất cả tour bên trong nó.';
$lang_module['delgroup_msg_rows_move'] = 'Hoặc chọn nhóm để di chuyển tour tới';
$lang_module['delgroupandrows'] = 'Xóa nhóm và các tour';
$lang_module['delgroup_msg_rows_noselect'] = 'Bạn cần chọn nhóm để di chuyển tour tới';
$lang_module['content_group'] = 'Là tour thuộc nhóm';
$lang_module['add_otherimage'] = 'Thêm hình minh họa khác';
$lang_module['file_selectfile'] = 'Chọn hình ảnh';
$lang_module['group_of'] = 'của Tour theo vùng';
